...
app.controller("ejemploCtrl", function($scope){
    ...
    var equipos_sel = [];
    var goles_equipos_sel = [];
    var cod_equipos_sel = [];
    for(i = 0; i < json.length; i++){
        equipos_sel.push(json[i].home_team_country);
        goles_equipos_sel.push(json[i].home_team.goals);
        cod_equipos_sel.push(json[i].home_team.code);
        equipos_sel.push(json[i].away_team_country);
        goles_equipos_sel.push(json[i].away_team.goals);
        cod_equipos_sel.push(json[i].away_team.code);
    }
    $scope.partidos = json;
    $scope.equipos = equipos_sel;
    $scope.goles = goles_equipos_sel;
    $scope.cod_equipos = cod_equipos_sel;
});